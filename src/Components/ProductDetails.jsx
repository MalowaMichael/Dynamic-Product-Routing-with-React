    ...
    <div className='flex flex-col p-2 gap-y-4 md:flex md:bg-transparent md:flex-row md:flex-nowrap md:items-center md:justify-between md:w-[94%] m-auto mt-[2%]   '>
      ...
      <div className='block bg-transparent shadow-xs w-full m-auto md:w-[60%] items-center '>
        <div className='flex flex-wrap justify-start gap-[2%] md:flex md:flex-wrap md:items-center md:justify-start '>
          <img src={product.image} alt={product.name} className='w-[70px] mt-[2%] md:h-[120px] md:w-[150px] '/>
          <img src={product.image} alt={product.name} className='w-[70px] mt-[2%] md:h-[120px] md:w-[150px] '/>
          <img src={product.image} alt={product.name} className='w-[70px] mt-[2%] md:h-[120px] md:w-[150px] '/>
          <img src={product.image} alt={product.name} className='w-[70px] mt-[2%] md:h-[120px] md:w-[150px] '/>
        </div>
        ...
        <div className='flex items-center justify-between gap-[3%] cursor-default  text-lg text-gray-600 hover:border-1px hover:border-gray-300 md:w-[50%] '>
          <div className='p-1 text-sm font-medium md:p-2 shadow-md rounded-sm md:text-lg md:font-medium w-[25%] text-center hover:shadow-lg'>S</div>
          <div className='p-1 text-sm font-medium md:p-2 shadow-md rounded-sm md:text-lg md:font-medium w-[25%] text-center hover:shadow-lg'>M</div>
          <div className='p-1 text-sm font-medium md:p-2 shadow-md rounded-sm md:text-lg md:font-medium w-[25%] text-center hover:shadow-lg'>L</div>
          <div className='p-1 text-sm font-medium md:p-2 shadow-md rounded-sm md:text-lg md:font-medium w-[25%] text-center hover:shadow-lg'>XL</div>
          <div className='p-1 text-sm font-medium md:p-2 shadow-md rounded-sm md:text-lg md:font-medium w-[25%] text-center hover:shadow-lg'>XXL</div>
        </div>
        
        <button className='text-white p-1 text-md font-normal w-full m-auto md:text-lg bg-[green] md:p-3 my-4 md:w-[50%] hover:cursor-pointer hover:text-[yellow]'>Add to cart</button>
        
        <div className="flex items-start mt-[2%] md:justify-between md:w-[90%] md:bg-green-600 ">
